![screenshot](https://raw.githubusercontent.com/DanielLob-o/filestash_rework_images/master/.assets/photo.jpg)

<p align="center">
    <a href="https://github.com/mickael-kerjean/contributors" alt="Contributors">
        <img src="https://img.shields.io/github/contributors/DanielLob-o/filestash_rework" style="max-width:100%;">
    </a>
...
<p align="center">
    <a href="https://demo.filestash.app">
        <img src="https://raw.githubusercontent.com/DanielLob-o/filestash_rework_images/master/.assets/navigation.gif" alt="user experience on navigation" />
    </a>
</p>
<p align="center">
    <a href="http://demo.filestash.app">
        <img src="https://raw.githubusercontent.com/DanielLob-o/filestash_rework_images/master/.assets/photo_management.gif" alt="user experience on medias" />
    </a>
</p>
...
The software is effectively 2 distinct parts: Core and [Plugins](https://github.com/DanielLob-o/filestash_rework/tree/master/server/plugin). Plugins act as "Lego blocks" that shape all the opinions on how the file manager operates, such as who can do what and where (aka, the authorisation), how the search features work (e.g., recursive search, full text search, ...), how users are authenticated (e.g., passthrough to the storage layer, LDAP, OIDC, SAML, signed URLs), how the application behaves when opening different file types, etc...
...
# Credits
- [Contributors](https://github.com/DanielLob-o/filestash_rework/graphs/contributors) and folks developing [awesome libraries](https://github.com/DanielLob-o/filestash_rework/blob/master/go.mod)
